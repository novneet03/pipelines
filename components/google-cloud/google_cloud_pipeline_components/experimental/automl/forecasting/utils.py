...
def get_bqml_arima_train_pipeline_and_parameters(  # pylint: disable=dangerous-default-value
    project: str,
    location: str,
    time_column: str,
...
def get_bqml_arima_predict_pipeline_and_parameters(  # pylint: disable=dangerous-default-value
    project: str,
    location: str,
    model_name: str,
    data_source: Dict[str, Dict[str, Union[List[str], str]]],
